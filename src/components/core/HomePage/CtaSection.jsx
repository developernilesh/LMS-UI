...
const CtaSection = () => {
  return (
    <section className="py-32 bg-gradient-to-br from-richblack-900 via-richblack-800 to-richblack-900 relative overflow-hidden">
      ...
      <div className="container mx-auto">
        <div className="w-11/12 max-w-6xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-12 animate-slideInLeft delay-600">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-pink-100 mb-1">200+</div>
